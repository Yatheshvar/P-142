...
import pandas as pd
from A_demo import output
from A_content import get_recommendations

articles_data = pd.read_csv('C:/Users/yathe/OneDrive/Desktop/python/Movie app/movie/Scripts/articles.csv')
